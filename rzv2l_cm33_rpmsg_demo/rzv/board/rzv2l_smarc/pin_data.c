...
#define USE_DE 0
...
#if USE_RTSCTS
    {
        .pin = BSP_IO_PORT_48_PIN_03,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_MODE1)
    },
    {
        .pin = BSP_IO_PORT_48_PIN_04,
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_MODE1)
    },
#endif
#if USE_DE
    ...
    //Enable GPIO
    {
         ...
         .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_MODE0 | (uint32_t)IOPORT_CFG_PORT_DIRECTION_OUTPUT_INPUT),
    },
    {
         .pin = BSP_IO_PORT_40_PIN_02,
         .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_MODE0 | (uint32_t)IOPORT_CFG_PORT_DIRECTION_OUTPUT_INPUT),
    },
