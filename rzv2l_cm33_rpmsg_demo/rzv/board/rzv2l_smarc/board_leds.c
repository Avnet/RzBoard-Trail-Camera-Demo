...
static const uint16_t g_bsp_prv_leds[] =
{
    ...
    // RZV2L-AVNET
     (uint16_t) BSP_IO_PORT_48_PIN_03,  ///< ePIN 11
     (uint16_t) BSP_IO_PORT_48_PIN_02,  ///< ePIN 13
     (uint16_t) BSP_IO_PORT_17_PIN_00,  ///< ePIN 15
     (uint16_t) BSP_IO_PORT_17_PIN_01,  ///< ePIN 12
};
