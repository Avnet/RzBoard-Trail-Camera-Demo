 ...
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_CLKON_FSP_IP_CRU(ch)     (R_BSP_CLKON(BSP_CLK_CRU, ch))

/***********************************************************************************************************************
 *
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_CLKOFF_FSP_IP_CRU(ch)     (R_BSP_CLKOFF(BSP_CLK_CRU, ch))

/***********************************************************************************************************************
 *
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_RSTON_FSP_IP_CRU(ch)      (R_BSP_RSTON(BSP_CLK_CRU, ch))

/***********************************************************************************************************************
 *
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_RSTOFF_FSP_IP_CRU(ch)     (R_BSP_RSTOFF(BSP_CLK_CRU, ch))

/***********************************************************************************************************************
 *
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_START_FSP_IP_CRU(ch)      (R_BSP_MSTPSTART(BSP_MSTP_MPCRU, 0))

/***********************************************************************************************************************
 *
 * @param      ch  The channel. Use ch 0 for units without channels. Only single bit can be set. ch 0 - 5.
 **********************************************************************************************************************/
#define R_BSP_MODULE_STOP_FSP_IP_CRU(ch)       (R_BSP_MSTPSTOP(BSP_MSTP_MPCRU, 0))
...
typedef enum e_fsp_ip
{
    ...
    FSP_IP_CRU = 10,                   ///< Camera Data Receiving Unit
} fsp_ip_t;
