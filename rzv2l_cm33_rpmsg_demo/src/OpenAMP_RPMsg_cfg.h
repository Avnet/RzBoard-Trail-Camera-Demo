...
// Memory region reserved between 0x43000000 - 0x43FFFFFF for RPMSG
#define RPMSG_MEM_BASE            (0x43000000U)
#define RPMSG_MEM_SIZE            (0x01000000U)
...
#define CFG_VRING_SHM_BASE1_PA    (0x43900000U)
#define CFG_VRING_SHM_BASE1_VA    (0x63900000U)
